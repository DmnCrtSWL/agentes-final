...
async function runQuotesMigration() {
    console.log('🔧 Iniciando migración de tabla quotes...\\n');
    ...
    try {
        ...
        const migrationPath = join(__dirname, 'migrations', '002_create_quotes_table.sql');
        ...
        // Verify table exists
        console.log('🔍 Verificando tabla "quotes"...');
        ...
        client.release();
        console.log('\\n✨ Migración de quotes completada exitosamente!');
